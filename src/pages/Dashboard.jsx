...
const DashboardPage = () => {
  ...
  return (
    <div className=" max-w-[1600px] mx-auto text-zinc-100 bg-zinc-950 min-h-screen space-y-6 animate-in fade-in duration-500">
      
      {/* Dashboard Greetings Header */}
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-800 pb-3">
        <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div className="bg-zinc-900  p-3 rounded-xl flex items-center justify-between shadow-xl relative overflow-hidden group hover:border-emerald-500/20 transition-all">
        ...
        <div className="bg-zinc-900  p-3 rounded-xl flex items-center justify-between shadow-xl relative overflow-hidden group hover:border-amber-500/20 transition-all">
          <div className="space-y-1">
        ...
        <div className="bg-zinc-900  p-3 rounded-xl flex items-center justify-between shadow-xl relative overflow-hidden group group-hover:border-blue-500/20 transition-all">
          <div className="space-y-1">
        ...
        <div className="bg-zinc-900  p-3 rounded-xl flex items-center justify-between shadow-xl relative overflow-hidden group hover:border-purple-500/20 transition-all">
          <div className="space-y-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-zinc-900 rounded-xl p-3 shadow-xl space-y-4 lg:col-span-1">
          ...
          <div className="space-y-2 overflow-y-auto max-h-[300px] pr-2">
            {outOfStockProducts.length === 0 ? (
              ...
              outOfStockProducts.map(p => (
                <div key={p._id} className="bg-red-500/5 bg-zinc-950 rounded-lg p-3 flex justify-between items-center">
                  <div>
                  ...
                  <span className="text-[10px] font-bold text-red-400 bg-red-500/10 px-2 py-0.5 rounded  uppercase font-mono">0 Stock</span>
                </div>
              ))
            )}
          </div>
        ...
        <div className="bg-zinc-900 rounded-xl p-4 shadow-xl space-y-4 lg:col-span-2">
